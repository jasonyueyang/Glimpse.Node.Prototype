...
function glimpseMiddleware(req, res, next) {
    ...
    runtime.beginRequest({
        ...
        var userIdMesage = glimpseMessages.userIDMessage(glimpseContext, uuid.v4(), "5414", null, "https://www.gravatar.com/avatar/D5F856634208232580DC59FC18E0414E.jpg?d=identicon");
        var beginRequestMessage = glimpseMessages.beginRequestMessage(glimpseContext, req.originalUrl);
